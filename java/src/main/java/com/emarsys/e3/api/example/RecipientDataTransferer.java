...
final class RecipientDataTransferer {
    ...
    String getRemoteFileName() {
        return ( config.getScpRemoteRootDirectory() + "/" + batchName );
    }
    ...
    private SshClient authenticate() throws IOException {
        ...
        String remoteHost = config.getScpRemoteHost();
        String scpUsername = config.getScpUsername();

        out.println( "Signing on to " + config.getScpRemoteHost() + " as " + scpUsername );
